...
public class ClientSMTP extends JFrame implements ActionListener{
	...
	private JLabel lblSpace,lblEmailusername,lblPass,lblTo,lblSubj,lblContent;
	private JTextArea logTextArea,textMessageArea;
	private JScrollPane logSCrollPanel,textScrollPane;
	private JButton btnSignIn,btnSend,btnExit;
	...
	public ClientSMTP() {
		...
		logSCrollPanel.setColumnHeaderView(btnExit);
		...
		textMessageArea.setBackground(UIManager.getColor("Button.background"));
		...
		btnSend.setIcon(new ImageIcon("D:\\Downloads\\new_mail_gmailmessage_7038.png"));
		btnSend.addActionListener(this);
		btnSend.setFont(new Font(".VnArial", Font.BOLD, 13));
		actionBtnPanel.add(btnSend, BorderLayout.NORTH);
